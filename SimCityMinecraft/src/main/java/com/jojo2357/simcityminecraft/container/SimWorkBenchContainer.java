...
public class SimWorkBenchContainer extends Container {
	public SimWorkBenchTileEntity tileEntity;
	...
	// public SimWorkBenchContainer(int p_i50078_1_, PlayerInventory p_i50078_2_) {
	...
	public SimWorkBenchContainer(int windowId, PlayerInventory p_i50079_2_, SimWorkBenchTileEntity p_i50079_3_) {
	...
	public void clickHappened(int index) {
		...
		if (index == 2)
			doFarming = false;
		this.tileEntity.setBuilding(doFarming);
	}
	...
	public boolean isFarming() {
		return this.tileEntity.isBuilding();
	}
